...
- 🏠 Home Automation & Smart Home Integration (Home Assistant / HACS)
- 📡 IoT, Networking & Embedded Systems
- 🛰️ Real-time data feeds, APIs & sensor integration
- 🐳 Containerization & self-hosted infrastructure
- 📻 Amateur Radio & RF
...
`Python` `Home Assistant` `HACS` `Real-time Data` `IoT`
